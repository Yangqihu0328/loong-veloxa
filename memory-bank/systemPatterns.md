...
## Phase 0 投入越深 / build phase 越快定律（TASK-20260502-02 反思 §2.1 — dual-evidence 入库）
...
**结论：** ROI ≈ 5× 是稳定数据点（dual-evidence 5.3× + 5.2×），可作为「Phase 0 投入合理性」的硬指标。
...
## lazy-attach C ABI 容错模式（TASK-20260502-02 反思 §4.5 — 新模式）
